...
public static class EndpointDefinitionExtensions
{
    ...
    public static IServiceCollection AddEndpointDefinition<TEndpoint>(this IServiceCollection services)
    ...
    public static WebApplication UseEndpointDefinition<TEndpoint>(this WebApplication app)
        where TEndpoint : IEndpointDefinition
    {
