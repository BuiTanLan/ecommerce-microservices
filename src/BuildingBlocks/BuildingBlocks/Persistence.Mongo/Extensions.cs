...
public static class Extensions
{
        ...
        where TContextImplementation : MongoDbContext, TContextService
    {
        ...
        services.AddTransient(typeof(IMongoRepository<,>), typeof(MongoDocumentRepository<,>));
        services.AddTransient(typeof(IMongoEventSourcedRepository<>), typeof(MongoEventSourcedRepository<>));
