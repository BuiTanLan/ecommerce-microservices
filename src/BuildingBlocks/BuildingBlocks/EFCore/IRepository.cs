...
public interface IRepository<TEntity, TKey> : IDisposable where TEntity : IAggregateRoot<TKey>
{
    Task<TEntity> FindById(TKey id, CancellationToken cancellationToken = default);
