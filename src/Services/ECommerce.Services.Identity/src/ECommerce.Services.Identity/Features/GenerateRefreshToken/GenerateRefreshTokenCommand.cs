    ...
    GenerateRefreshTokenCommandHandler : ICommandHandler<GenerateRefreshTokenCommand, GenerateRefreshTokenCommandResult>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            var token = global::ECommerce.Services.Identity.Share.Core.Models.RefreshToken.GetRefreshToken();

            refreshToken = new global::ECommerce.Services.Identity.Share.Core.Models.RefreshToken
            {
            ...
            await _context.Set<global::ECommerce.Services.Identity.Share.Core.Models.RefreshToken>().AddAsync(refreshToken, cancellationToken);
        ...
        else
        {
            ...
            _context.Set<global::ECommerce.Services.Identity.Share.Core.Models.RefreshToken>().Update(refreshToken);
            await _context.SaveChangesAsync(cancellationToken);
        }
    ...
    {
        var refreshTokens = _context.Set<global::ECommerce.Services.Identity.Share.Core.Models.RefreshToken>().Where(rt => rt.UserId == userId);
