...
using Catalogs.Products.Events.Domain;
using Catalogs.Products.Exceptions.Domain;
using Catalogs.Products.Features.ChangingProductBrand.Events.Domain;
using Catalogs.Products.Features.ChangingProductCategory.Events;
using Catalogs.Products.Features.ChangingProductPrice;
using Catalogs.Products.Features.ChangingProductSupplier.Events;
