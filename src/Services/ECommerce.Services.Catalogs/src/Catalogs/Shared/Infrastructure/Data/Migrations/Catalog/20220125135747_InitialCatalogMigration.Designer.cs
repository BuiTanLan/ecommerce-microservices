...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Catalogs.Brands.Brand", b =>
                {
                    b.Property<long>("Id")
            ...
            modelBuilder.Entity("Catalogs.Categories.Category", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Catalogs.Products.Models.Product", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Catalogs.Products.Models.ProductImage", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Catalogs.Products.Models.ProductView", b =>
                {
                    b.Property<long>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Catalogs.Suppliers.Supplier", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Catalogs.Products.Models.Product", b =>
                {
                    b.HasOne("Catalogs.Brands.Brand", "Brand")
                        .WithMany()
                    ...
                    b.HasOne("Catalogs.Categories.Category", "Category")
                        .WithMany()
                    ...
                    b.HasOne("Catalogs.Suppliers.Supplier", "Supplier")
                        .WithMany()
                    ...
                    b.OwnsOne("Catalogs.Products.Models.ValueObjects.Dimensions", "Dimensions", b1 =>
                        {
            ...
            modelBuilder.Entity("Catalogs.Products.Models.ProductImage", b =>
                {
                    b.HasOne("Catalogs.Products.Models.Product", "Product")
                        .WithMany("Images")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
